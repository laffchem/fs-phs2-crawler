...
export default class FSCrawler {
    ...
    async scrapeCategories() {
        try {
            ...
            this.delay(10000); // 10 second wait to scrape all the stuff.
                ...
                await fetch(item.url)
                    .then(async (response) => {
                        if (response) {
                            ...
                            console.error(
                                'Response object is null. Page navigation failed.'
                            );
                        }
                    })
                    .catch((err) => {
    ...
    async _scrapeProducts(page) {
        ...
        await new Promise((resolve) => {
            setTimeout(resolve, 1000); // 5 second delay to not get IP blocked
        });
    }
